...
import { 
  ...
  MdCheckCircle,
  MdSend,
  MdHistoryToggleOff,  // Reemplaza MdFlexible
  MdEventAvailable,    // Alternativa para flexibilidad
  MdSwapHoriz         // Otra alternativa
} from "react-icons/md";
import { 
  GiHouse,
  GiCarKey,
    ...
    <div className="container">
      ...
      <div className="detail-box">
        ...
        <div className="detail-features">
          ...
          <div className="feature-item">
            <MdHistoryToggleOff className="feature-icon" /> {/* Cambiado */}
